...
4. **Agent Context**: Agents MUST exclude `public/data/` from their context (respecting `.gitignore`) to prevent token bloat. Use `tests/fixtures/public-data/` if data schema analysis is required.
