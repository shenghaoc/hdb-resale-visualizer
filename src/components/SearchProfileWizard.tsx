                    ...
                    {options.flatTypes.map((flatType) => {
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            "rounded-[0.65rem] px-5 py-2.5 text-[0.82rem] font-bold tracking-[0.02em] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50",
                            selected
                    ...
                    {budgetPresets.map((preset) => {
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            "rounded-[0.55rem] border px-3.5 py-2 text-xs font-bold [font-variant-numeric:tabular-nums] transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50",
                            active
                        ...
                        {commutePresets.map((preset) => {
                          ...
                          return (
                            <button
                              ...
                              className={cn(
                                "rounded-[0.55rem] border px-3.5 py-2 text-xs font-bold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50",
                                active
                                  ? "border-primary bg-primary text-primary-foreground"
                                  : "border-border bg-secondary text-secondary-foreground hover:bg-secondary/80",
                              )}
