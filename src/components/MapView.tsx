...
import maplibregl, { LngLatBoundsLike, Map as MapLibreMap, Popup, PropertyValueSpecification } from "maplibre-gl";
  ...
  useEffect(() => {
    ...
    map.on("load", () => {
      ...
      map.addLayer({
        ...
        filter: ["!", ["has", "point_count"]],
        paint: {
          "circle-color": MEDIAN_PRICE_COLOR_EXPRESSION as PropertyValueSpecification<string>,
