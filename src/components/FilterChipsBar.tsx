...
const chipLayoutClass =
  "filter-chip flex shrink-0 items-center justify-center gap-1 rounded-none border px-3 py-1.5 text-[0.75rem] font-semibold uppercase tracking-[var(--tracking-wide)] leading-none shadow-sm transition-[color,background-color,box-shadow,transform] min-h-11 min-w-11 sm:min-h-min sm:min-w-min text-box-trim";
