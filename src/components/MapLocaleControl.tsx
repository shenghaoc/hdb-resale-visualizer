 ...
 */
export function MapLocaleControl({ isDesktop, className }: MapLocaleControlProps) {
  return (
    <div
      ...
      className={cn(
        ...
        isDesktop
          ? "right-6 top-6"
          : "right-3 top-[calc(env(safe-area-inset-top,0px)+0.75rem)]",
        className,
      )}
    >
