...
**Learning:** Custom UI buttons that function as toggles (like the Bookmark/Save icon buttons) often lack the explicit explicit `aria-pressed` attribute, causing screen reader users to miss their active state entirely.
