...
-- cannot use the index. Drop the mis-parenthesised index from 0005 and recreate it
-- with the full expression parenthesised. Using a new numbered migration (rather than
-- editing 0005) self-corrects any database that already applied the buggy 0005.
